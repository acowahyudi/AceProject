...
const FirstRoute = () => (
  <View style={[styles.container, { backgroundColor: '#ff4081' }]} ><Text>zzaaaaaaaaa</Text>
  </View>
);
const SecondRoute = () => (
...
export default class TabViewExample extends React.Component {
  ...
  state = {
    index: 0,
    routes: [{ key: '1', title: 'First',icon: 'ios-paper', }, {icon: 'ios-paper', key: '2', title: 'Second' }, {icon: 'ios-paper', key: '3', title: 'Second' }],
  };
